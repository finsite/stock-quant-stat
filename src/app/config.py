"""Repo-specific configuration for stock-quant-stat."""
...
def get_poller_name() -> str:
    ...
    return get_config_value("POLLER_NAME", "stock_quant_stat")


def get_rabbitmq_queue() -> str:
    """Return the RabbitMQ queue name for this poller."""
    return get_config_value("RABBITMQ_QUEUE", "stock_quant_stat_queue")


def get_dlq_name() -> str:
    """Return the Dead Letter Queue (DLQ) name for this poller."""
    return get_config_value("DLQ_NAME", "stock_quant_stat_dlq")
